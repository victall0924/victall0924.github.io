...
["角平分線；分角線","angular bisector","角平分线；分角线","jiǎo píng fèn xiàn ；fèn jiǎo xiàn ","gok3ping4/peng4fan1/fan6sin3；fan1/fan6gok3sin3"],
...
["公理；公設","axiom","公理；公设","gōng lǐ ；gōng shè ","gung1lei5；gung1cit3"],
...
["特徵的；特性的；示性的；特徵數；示性數","characteristic","特征的；特性的；示性的；特征数；示性数","tè zhēng de ；tè xìng de ；shì xìng de ；tè zhēng shù ；shì xìng shù ","dak6zing1dik1；dak6sing3dik1；si6sing3dik1；dak6zing1sou3/sou2；si6sing3sou3/sou2"],
...
["合數","composite number","合数","hé shù ","hap6sou3/sou2"],
...
["立方根","cubic root","立方根","lì fāng gēn ","lap6/laap6fong1gan1"],
...
["導數","derivative","导数","dǎo shù ","jing1/jing3bin3sou3/sou2；ji1bin3sou3/sou2；jan1bin3sou3/sou2；jing1/jing3bin3loeng4"],
...
["有效截斷頻率","effective cut-off frequency","有效截断频率","yǒu xiào jié duàn pín lǜ ","jau5haau6ho2gai3syun3sing3"],
...
["球面的標準式","equation of sphere in standard form","球面的标准式","qiú miàn de biāo zhǔn shì ","kau4min6dik1jat1bun1sik1"],
...
["第一卦限","first octant","第一卦限","dì yī guà xiàn ","jau5haan6zaap6[hap6]"],
...
["能識性","identifiability","能识性","néng shí xìng ","hang4dang2ju1ling4"],
...
["截距式","intercept form","截距式","jié jù shì ","zit6keoi5"],
...
["領導係數；首項係數","leading coefficient","领导系数；首项系数","lǐng dǎo xì shù ；shǒu xiàng xì shù ","ling5/leng2dou6hai6sou3/sou2；sau2hong6hai6sou3/sou2"],
...
["公升","liter","公升","gōng shēng ","gung1sing1"],
...
["最小[值]；極小[值]","minimum","最小[值]；极小[值]","zuì xiǎo [zhí ]；jí xiǎo [zhí ]","zeoi3siu2[zik6]；gik6siu2[zik6]"],
["短軸","minor axis","短轴","duǎn zhóu ","dyun2zuk6"],
["被減數","minuend","被减数","bèi jiǎn shù ","bei6/pei5gaam2sou3/sou2"],
["減；負的","minus","减；负的","jiǎn ；fù de ","gaam2；fu6dik1"],
["減號；負號","minus sign","减号；负号","jiǎn hào ；fù hào ","gaam2hou6；fu6hou6"],
["分","minute","分","fèn ","fan1/fan6"],
["衆數；方式","mode","众数；方式","zhōng shù ；fāng shì ","zung3sou3/sou2；fong1sik1"],
["模；模數；絕對值；尺度","modulus","模；模数；绝对值；尺度","mó ；mó shù ；jué duì zhí ；chǐ dù ","mou4；mou4sou3/sou2；zyut6deoi3zik6；cek3dou6"],
["單項式；單項的","monomial","单项式；单项的","dān xiàng shì ；dān xiàng de ","daan1hong6sik1；daan1hong6dik1"],
["以上累積次數分布；以上累積次數分配","more than cumulative frequency distribution","以上累积次数分布；以上累积次数分配","yǐ shàng lèi jī cì shù fèn bù ；yǐ shàng lèi jī cì shù fèn pèi ","ji5soeng6/soeng5leoi6zik1ci3sou3/sou2fan1/fan6bou3；ji5soeng6/soeng5leoi6zik1ci3sou3/sou2fan1/fan6pui3"],
["倍數；倍式；多重","multiple","倍数；倍式；多重","bèi shù ；bèi shì ；duō zhòng ","pui5sou3/sou2；pui5sik1；do1cung5/zung6"],
["被乘數；被乘式","multiplicand","被乘数；被乘式","bèi chéng shù ；bèi chéng shì ","bei6/pei5sing4sou3/sou2；bei6/pei5sing4sik1"],
["乘法","multiplication","乘法","chéng fǎ ","sing4faat3"],
["乘法原理；乘法法則","multiplication rule","乘法原理；乘法法则","chéng fǎ yuán lǐ ；chéng fǎ fǎ zé ","sing4faat3jun4lei5；sing4faat3faat3zak1"],
["乘數；乘式；乘子","multiplier","乘数；乘式；乘子","chéng shù ；chéng shì ；chéng zǐ ","sing4sou3/sou2；sing4sik1；sing4zi2"],
...
["n次方根","n-th root","n次方根","ncì fāng gēn ","nci3fong1gan1"],
...
["負角恆等式；負角關係式","negative angle identity","负角恒等式；负角关系式","fù jiǎo héng děng shì ；fù jiǎo guān xì shì ","fu6gok3hang4dang2sik1；fu6gok3gwaan1hai6sik1"],
...
["常態分布；常態分配","normal distribution","常态分布；常态分配","cháng tài fèn bù ；cháng tài fèn pèi ","soeng4taai3fan1/fan6bou3；soeng4taai3fan1/fan6pui3"],
["範式；正規形式；法線式","normal form","范式；正规形式；法线式","fàn shì ；zhèng guī xíng shì ；fǎ xiàn shì ","faan6sik1；zing3/zeng3kwai1jing4sik1；faat3sin3sik1"],
["法線","normal line","法线","fǎ xiàn ","faat3sin3"],
["法向量","normal vector","法向量","fǎ xiàng liàng ","faat3hoeng3loeng4"],
["零向量","null vector","零向量","líng xiàng liàng ","ling4hoeng3loeng4"],
["數線","number line","数线","shù xiàn ","sou3/sou2sin3"],
["分子","numerator","分子","fèn zǐ ","fan1/fan6zi2"],
["目標函數","objective function","目标函数","mù biāo hán shù ","muk6biu1haam4sou3/sou2"],
["八邊形","octagon","八边形","bā biān xíng ","baat3bin1jing4"],
["卦限","octant","卦限","guà xiàn ","gwaa3haan6"],
["奇數","odd number","奇数","qí shù ","kei4sou3/sou2"],
["肩形曲線","ogive curve","肩形曲线","jiān xíng qǔ xiàn ","gin1jing4kuk1sin3"],
...
["有序偶；[有序]數對","ordered pair","有序偶；[有序]数对","yǒu xù ǒu ；[yǒu xù ]shù duì ","jau5zeoi6ngau5；[jau5zeoi6]sou3/sou2deoi3"],
["順序的；次序的；序數","ordinal","顺序的；次序的；序数","shùn xù de ；cì xù de ；xù shù ","seon6zeoi6dik1；ci3zeoi6dik1；zeoi6sou3/sou2"],
["序數代數","ordinal algebra","序数代数","xù shù dài shù ","zeoi6sou3/sou2doi6sou3/sou2"],
["序數記號","ordinal notation","序数记号","xù shù jì hào ","zeoi6sou3/sou2gei3hou6"],
["序數","ordinal number","序数","xù shù ","zeoi6sou3/sou2"],
["序數冪","ordinal power","序数幂","xù shù mì ","zeoi6sou3/sou2mik6"],
["序數積","ordinal product","序数积","xù shù jī ","zeoi6sou3/sou2zik1"],
["順序關係","ordinal relation","顺序关系","shùn xù guān xì ","seon6zeoi6gwaan1hai6"],
["序數和","ordinal sum","序数和","xù shù hé ","zeoi6sou3/sou2wo4"],
["縱[坐]標","ordinate","纵[坐]标","zòng [zuò ]biāo ","zung3[zo6/co5]biu1"],
["原點","origin","原点","yuán diǎn ","jun4dim2"],
["正交；直交","orthogonal","正交；直交","zhèng jiāo ；zhí jiāo ","zing3/zeng3gaau1；zik6gaau1"],
["正[交]射影","orthogonal projection","正[交]射影","zhèng [jiāo ]shè yǐng ","zing3/zeng3[gaau1]se6jing2"],
["拋物線","parabola","抛物线","pāo wù xiàn ","paau1mat6sin3"],
["平行","parallel","平行","píng háng ","ping4/peng4hang4/haang4/hong4"],
["平行公設；平行公理","parallel axiom","平行公设；平行公理","píng háng gōng shè ；píng háng gōng lǐ ","ping4/peng4hang4/haang4/hong4gung1cit3；ping4/peng4hang4/haang4/hong4gung1lei5"],
...
["參數；參變量","parameter","参数；参变量","cān shù ；cān biàn liàng ","caam1/sam1sou3/sou2；caam1/sam1bin3loeng4"],
["參數方程[式]","parametric equation","参数方程[式]","cān shù fāng chéng [shì ]","caam1/sam1sou3/sou2fong1cing4[sik1]"],
["直線參數式","parametric equation of line","直线参数式","zhí xiàn cān shù shì ","zik6sin3caam1/sam1sou3/sou2sik1"],
["分割","partition","分割","fèn gē ","fan1/fan6got3"],
...
["循環小數","periodic decimal","循环小数","xún huán xiǎo shù ","ceon4waan4siu2sou3/sou2"],
["週期函數","periodic function","周期函数","zhōu qī hán shù ","zau1kei4haam4sou3/sou2"],
["排列；置換","permutation","排列；置换","pái liè ；zhì huàn ","paai4/paai2lit6；zi3wun6"],
["垂直[於]","perpendicular","垂直[于]","chuí zhí [yú ]","seoi4zik6[ju1]"],
["圓形圖","pie chart","圆形图","yuán xíng tú ","jun4jing4tou4"],
["平面","plane","平面","píng miàn ","ping4/peng4min6"],
["平面直角坐標系","plane rectangular coordinate system","平面直角坐标系","píng miàn zhí jiǎo zuò biāo xì ","ping4/peng4min6zik6gok3zo6/co5biu1hai6"],
["加；加號；正的","plus","加；加号；正的","jiā ；jiā hào ；zhèng de ","gaa1；gaa1hou6；zing3/zeng3dik1"],
["點","point","点","diǎn ","dim2"],
["點圓","point circle","点圆","diǎn yuán ","dim2jun4"],
["反曲點；拐點","point of inflection","反曲点；拐点","fǎn qǔ diǎn ；guǎi diǎn ","faan2kuk1dim2；gwaai2dim2"],
["參考點；基準點","point of reference","参考点；基准点","cān kǎo diǎn ；jī zhǔn diǎn ","caam1/sam1haau2dim2；gei1zeon2dim2"],
...
["單變數多項式；一元多項式","polynomial in one variable","单变数多项式；一元多项式","dān biàn shù duō xiàng shì ；yī yuán duō xiàng shì ","daan1bin3sou3/sou2do1hong6sik1；jat1jun4do1hong6sik1"],
["零次多項式","polynomial of degree zero","零次多项式","líng cì duō xiàng shì ","ling4ci3do1hong6sik1"],
["高次多項式","polynomial of higher degree","高次多项式","gāo cì duō xiàng shì ","gou1ci3do1hong6sik1"],
...
["位置向量","position vector","位置向量","wèi zhì xiàng liàng ","wai6/wai2zi3hoeng3loeng4"],
["正角","positive angle","正角","zhèng jiǎo ","zing3/zeng3gok3"],
...
["[乘]冪；次方；功率","power","[乘]幂；次方；功率","[chéng ]mì ；cì fāng ；gōng lǜ ","[sing4]mik6；ci3fong1；gung1leot6/leot2"],
["冪函數；檢定力函數","power function","幂函数；检定力函数","mì hán shù ；jiǎn dìng lì hán shù ","mik6haam4sou3/sou2；gim2ding6lik6haam4sou3/sou2"],
["質；質式；質數","prime","质；质式；质数","zhì ；zhì shì ；zhì shù ","zat1；zat1sik1；zat1sou3/sou2"],
["質因子；質因數；質因式","prime factor","质因子；质因数；质因式","zhì yīn zǐ ；zhì yīn shù ；zhì yīn shì ","zat1jan1zi2；zat1jan1sou3/sou2；zat1jan1sik1"],
["質數","prime number","质数","zhì shù ","zat1sou3/sou2"],
["主輻角","principal argument","主辐角","zhǔ fú jiǎo ","zyu2fuk1gok3"],
["取捨原理；排容原理","principle of inclusion and exclusion","取舍原理；排容原理","qǔ shě yuán lǐ ；pái róng yuán lǐ ","ceoi2se2jun4lei5；paai4/paai2jung4jun4lei5"],
["機率","probability","机率","jī lǜ ","gei1leot6/leot2"],
["機率分布；機率分配","probability distribution","机率分布；机率分配","jī lǜ fèn bù ；jī lǜ fèn pèi ","gei1leot6/leot2fan1/fan6bou3；gei1leot6/leot2fan1/fan6pui3"],
["積集合","product set","积集合","jī jí hé ","zik1zaap6hap6"],
["射影；射影算子；投影","projection","射影；射影算子；投影","shè yǐng ；shè yǐng suàn zǐ ；tóu yǐng ","se6jing2；se6jing2syun3zi2；tau4jing2"],
["純虛數","pure imaginary number","纯虚数","chún xū shù ","seon4heoi1sou3/sou2"],
["稜錐[體]；角錐[體]","pyramid","棱锥[体]；角锥[体]","léng zhuī [tǐ ]；jiǎo zhuī [tǐ ]","ling4zeoi1[tai2]；gok3zeoi1[tai2]"],
["畢達哥拉斯","Pythagoras","毕达哥拉斯","bì dá gē lā sī ","bat1daat6go1laai1si1"],
["平方關係式；平方恆等式","Pythagorean identity","平方关系式；平方恒等式","píng fāng guān xì shì ；píng fāng héng děng shì ","ping4/peng4fong1gwaan1hai6sik1；ping4/peng4fong1hang4dang2sik1"],
["畢氏定理；商高定理；勾股[弦]定理","Pythagorean theorem","毕氏定理；商高定理；勾股[弦]定理","bì shì dìng lǐ ；shāng gāo dìng lǐ ；gōu gǔ [xián ]dìng lǐ ","bat1si6ding6lei5；soeng1gou1ding6lei5；ngau1gu2[jin4]ding6lei5"],
...
["定性數據","qualitative data","定性数据","dìng xìng shù jù ","ding6sing3sou3/sou2geoi3"],
["定量數據","quantitative data","定量数据","dìng liàng shù jù ","ding6loeng4sou3/sou2geoi3"],
...
["商[數]；商式","quotient","商[数]；商式","shāng [shù ]；shāng shì ","soeng1[sou3/sou2]；soeng1sik1"],
["商數關係式；商數恆等式","quotient identity","商数关系式；商数恒等式","shāng shù guān xì shì ；shāng shù héng děng shì ","soeng1sou3/sou2gwaan1hai6sik1；soeng1sou3/sou2hang4dang2sik1"],
["商數關係式","quotient relation","商数关系式","shāng shù guān xì shì ","soeng1sou3/sou2gwaan1hai6sik1"],
["弧度；弳[度]","radian","弧度；弪[度]","hú dù ；jìng [dù ]","wu4dou6；ging3[dou6]"],
["弧度；弧度法","radian measure","弧度；弧度法","hú dù ；hú dù fǎ ","wu4dou6；wu4dou6faat3"],
["弧度制；弳度制","radian system","弧度制；弪度制","hú dù zhì ；jìng dù zhì ","wu4dou6zai3；ging3dou6zai3"],
["根數；根式；根基","radical","根数；根式；根基","gēn shù ；gēn shì ；gēn jī ","gan1sou3/sou2；gan1sik1；gan1gei1"],
["半徑","radius","半径","bàn jīng ","bun3ging3"],
["隨機試驗","random experiment","随机试验","suí jī shì yàn ","ceoi4gei1si3jim6"],
["亂數表；隨機號碼表","random numbers table","乱数表；随机号码表","luàn shù biǎo ；suí jī hào mǎ biǎo ","lyun6sou3/sou2biu2；ceoi4gei1hou6maa5biu2"],
["隨機變數","random variable","随机变数","suí jī biàn shù ","ceoi4gei1bin3sou3/sou2"],
["區域；範圍；值域；全距","range","区域；范围；值域；全距","qū yù ；fàn wéi ；zhí yù ；quán jù ","keoi1wik6；faan6wai4；zik6wik6；cyun4keoi5"],
["值域","range of values","值域","zhí yù ","zik6wik6"],
["圓周率；π","ratio of the circumference of a circle to its diameter","圆周率；π","yuán zhōu lǜ ；π","jun4zau1leot6/leot2；π"],
["有理指數","rational exponent","有理指数","yǒu lǐ zhǐ shù ","jau5lei5zi2sou3/sou2"],
["有理數","rational number","有理数","yǒu lǐ shù ","jau5lei5sou3/sou2"],
["有理點","rational point","有理点","yǒu lǐ diǎn ","jau5lei5dim2"],
["有理根","rational root","有理根","yǒu lǐ gēn ","jau5lei5gan1"],
["射線","ray","射线","shè xiàn ","se6sin3"],
["實數","real number","实数","shí shù ","sat6sou3/sou2"],
["實部","real part","实部","shí bù ","sat6bou6"],
["倒數關係式；倒數恆等式","reciprocal identity","倒数关系式；倒数恒等式","dǎo shù guān xì shì ；dǎo shù héng děng shì ","dou2sou3/sou2gwaan1hai6sik1；dou2sou3/sou2hang4dang2sik1"],
["倒數關係","reciprocal relation","倒数关系","dǎo shù guān xì ","dou2sou3/sou2gwaan1hai6"],
["長方形；矩形","rectangle","长方形；矩形","zhǎng fāng xíng ；jǔ xíng ","coeng4/zoeng2fong1jing4；geoi2jing4"],
...
["遞迴公式","recurrence formula","递回公式","dì huí gōng shì ","dai6wui4gung1sik1"],
["循環節","recurring period","循环节","xún huán jiē ","ceon4waan4zit3"],
["遞迴公式","recursion formula","递回公式","dì huí gōng shì ","dai6wui4gung1sik1"],
["遞迴關係","recursive relation","递回关系","dì huí guān xì ","dai6wui4gwaan1hai6"],
["參考角","reference angle","参考角","cān kǎo jiǎo ","caam1/sam1haau2gok3"],
...
["相對極大[值]","relative maximum","相对极大[值]","xiàng duì jí dà [zhí ]","soeng1/soeng2/soeng3deoi3gik6daai6[zik6]"],
["相對極大[值]","relative maximum value","相对极大[值]","xiàng duì jí dà [zhí ]","soeng1/soeng2/soeng3deoi3gik6daai6[zik6]"],
["相對極小[值]","relative minimum","相对极小[值]","xiàng duì jí xiǎo [zhí ]","soeng1/soeng2/soeng3deoi3gik6siu2[zik6]"],
["相對極小[值]","relative minimum value","相对极小[值]","xiàng duì jí xiǎo [zhí ]","soeng1/soeng2/soeng3deoi3gik6siu2[zik6]"],
["互質","relatively prime","互质","hù zhì ","wu6zat1"],
["餘數；餘式；餘項；剩餘","remainder","余数；余式；余项；剩余","yú shù ；yú shì ；yú xiàng ；shèng yú ","ju4sou3/sou2；ju4sik1；ju4hong6；zing6ju4"],
["餘式定理","remainder theorem","余式定理","yú shì dìng lǐ ","ju4sik1ding6lei5"],
...
["循環小數","repeating decimal","循环小数","xún huán xiǎo shù ","ceon4waan4siu2sou3/sou2"],
["坐標表示[法]","representation in coordinates","坐标表示[法]","zuò biāo biǎo shì [fǎ ]","zo6/co5biu1biu2si6[faat3]"],
["共鳴；共振","resonance","共鸣；共振","gòng míng ；gòng zhèn ","gung6ming4；gung6zan3"],
["合力","resultant force","合力","hé lì ","hap6lik6"],
...
["法[則]；規則；律","rule","法[则]；规则；律","fǎ [zé ]；guī zé ；lǜ ","faat3[zak1]；kwai1zak1；leot6"],
["加法原理","rule of addition","加法原理","jiā fǎ yuán lǐ ","gaa1faat3jun4lei5"],
["全機率法則","rule of total probability","全机率法则","quán jī lǜ fǎ zé ","cyun4gei1leot6/leot2faat3zak1"],
["直尺","ruler","直尺","zhí chǐ ","zik6cek3"],
["樣本","sample","样本","yàng běn ","joeng6bun2"],
["樣本平均數[值]","sample mean","样本平均数[值]","yàng běn píng jun1 shù [zhí ]","joeng6bun2ping4/peng4gwan1sou3/sou2[zik6]"],
...
["純量","scalar","纯量","chún liàng ","seon4loeng4"],
["純量乘法；係數積","scalar multiplication","纯量乘法；系数积","chún liàng chéng fǎ ；xì shù jī ","seon4loeng4sing4faat3；hai6sou3/sou2zik1"],
["散布圖","scatter diagram","散布图","sàn bù tú ","saan3bou3tou4"],
["科學記法；科學記號","scientific notation","科学记法；科学记号","kē xué jì fǎ ；kē xué jì hào ","fo1hok6gei3faat3；fo1hok6gei3hou6"],
["正割；割線","secant","正割；割线","zhèng gē ；gē xiàn ","zing3/zeng3got3；got3sin3"],
["正割函數","secant function","正割函数","zhèng gē hán shù ","zing3/zeng3got3haam4sou3/sou2"],
["割線","secant line","割线","gē xiàn ","got3sin3"],
["秒","second","秒","miǎo ","miu5"],
["第二四分位數","second quartile","第二四分位数","dì èr sì fèn wèi shù ","dai6ji6sei3fan1/fan6wai6/wai2sou3/sou2"],
["扇形","sector","扇形","shàn xíng ","sin3jing4"],
["級數","series","级数","jí shù ","kap1sou3/sou2"],
["降冪級數","series of decreasing powers","降幂级数","jiàng mì jí shù ","gong3/hong4mik6kap1sou3/sou2"],
["集[合]","set","集[合]","jí [hé ]","zaap6[hap6]"],
["六十進位制","sexagesimal system","六十进位制","liù shí jìn wèi zhì ","luk6sap6zeon3wai6/wai2zai3"],
["邊；側","side","边；侧","biān ；cè ","bin1；zak1"],
["等號","sign of equality","等号","děng hào ","dang2hou6"],
["有效數[字]","significant figure","有效数[字]","yǒu xiào shù [zì ]","jau5haau6sou3/sou2[zi6]"],
...
["反對稱矩陣；斜矩陣","skew matrix","反对称矩阵；斜矩阵","fǎn duì chēng jǔ zhèn ；xié jǔ zhèn ","faan2deoi3cing1geoi2zan6；ce4geoi2zan6"],
["斜對稱方陣","skew symmetric matrix","斜对称方阵","xié duì chēng fāng zhèn ","ce4deoi3cing1fong1zan6"],
["斜率","slope","斜率","xié lǜ ","ce4leot6/leot2"],
["斜率函數","slope function","斜率函数","xié lǜ hán shù ","ce4leot6/leot2haam4sou3/sou2"],
["斜截式","slope-intercept form","斜截式","xié jié shì ","ce4zit6sik1"],
["小於","smaller than","小于","xiǎo yú ","siu2ju1"],
["平滑曲線","smooth curve","平滑曲线","píng huá qǔ xiàn ","ping4/peng4waat6kuk1sin3"],
["立體錐；錐體","solid cone","立体锥；锥体","lì tǐ zhuī ；zhuī tǐ ","lap6/laap6tai2zeoi1；zeoi1tai2"],
["旋轉體；迴轉體","solid of revolution","旋转体；回转体","xuán zhuǎn tǐ ；huí zhuǎn tǐ ","syun4zyun3tai2；wui4zyun3tai2"],
["實心球","solid sphere","实心球","shí xīn qiú ","sat6sam1kau4"],
["南極","south pole","南极","nán jí ","naam4gik6"],
["空間","space","空间","kōng jiān ","hung1gaan1/gaan3"],
["空間坐標系","space coordinate system","空间坐标系","kōng jiān zuò biāo xì ","hung1gaan1/gaan3zo6/co5biu1hai6"],
["球[形]；球面","sphere","球[形]；球面","qiú [xíng ]；qiú miàn ","kau4[jing4]；kau4min6"],
["正方形；平方","square","正方形；平方","zhèng fāng xíng ；píng fāng ","zing3/zeng3fong1jing4；ping4/peng4fong1"],
...
["標準分解[式]","standard factorization","标准分解[式]","biāo zhǔn fèn jiě [shì ]","biu1zeon2fan1/fan6gaai2[sik1]"],
["標準[形]式","standard form","标准[形]式","biāo zhǔn [xíng ]shì ","biu1zeon2[jing4]sik1"],
["標準計分","standard score","标准计分","biāo zhǔn jì fèn ","biu1zeon2gai3fan1/fan6"],
["標準化","standardization","标准化","biāo zhǔn huà ","biu1zeon2faa3"],
["統計圖","statistical graph","统计图","tǒng jì tú ","tung2gai3tou4"],
["統計推論","statistical inference","统计推论","tǒng jì tuī lùn ","tung2gai3teoi1leon6"],
["統計表","statistical table","统计表","tǒng jì biǎo ","tung2gai3biu2"],
["統計學","statistics","统计学","tǒng jì xué ","tung2gai3hok6"],
["直線相關","straight line correlation","直线相关","zhí xiàn xiàng guān ","zik6sin3soeng1/soeng2/soeng3gwaan1"],
["分層隨機抽樣[法]","stratified random sampling","分层随机抽样[法]","fèn céng suí jī chōu yàng [fǎ ]","fan1/fan6cang4ceoi4gei1cau1joeng6[faat3]"],
["分層隨機抽樣法","stratified random sampling method","分层随机抽样法","fèn céng suí jī chōu yàng fǎ ","fan1/fan6cang4ceoi4gei1cau1joeng6faat3"],
["分層抽樣","stratified sampling","分层抽样","fèn céng chōu yàng ","fan1/fan6cang4cau1joeng6"],
...
["減法","subtraction","减法","jiǎn fǎ ","gaam2faat3"],
["向量的減法","subtraction of vectors","向量的减法","xiàng liàng de jiǎn fǎ ","hoeng3loeng4dik1gaam2faat3"],
["減數","subtrahend","减数","jiǎn shù ","gaam2sou3/sou2"],
["成功機率","success probability","成功机率","chéng gōng jī lǜ ","sing4gung1gei1leot6/leot2"],
["和；總數","sum","和；总数","hé ；zǒng shù ","wo4；zung2sou3/sou2"],
...
["被加數；被加項","summand","被加数；被加项","bèi jiā shù ；bèi jiā xiàng ","bei6/pei5gaa1sou3/sou2；bei6/pei5gaa1hong6"],
["補角","supplementary angle","补角","bǔ jiǎo ","bou2gok3"],
["必然事件","sure event","必然事件","bì rán shì jiàn ","bit1jin4si6gin6"],
...
["對稱方陣；對稱矩陣","symmetric matrix","对称方阵；对称矩阵","duì chēng fāng zhèn ；duì chēng jǔ zhèn ","deoi3cing1fong1zan6；deoi3cing1geoi2zan6"],
["綜合除法","synthetic division","综合除法","zōng hé chú fǎ ","zung1hap6ceoi4faat3"],
["方程組","system of equations","方程组","fāng chéng zǔ ","fong1cing4zou2"],
...
["系統抽樣","systematic sampling","系统抽样","xì tǒng chōu yàng ","hai6tung2cau1joeng6"],
["對數表","table of logarithm","对数表","duì shù biǎo ","deoi3sou3/sou2biu2"],
["亂數表；隨機號碼表","table of random numbers","乱数表；随机号码表","luàn shù biǎo ；suí jī hào mǎ biǎo ","lyun6sou3/sou2biu2；ceoi4gei1hou6maa5biu2"],
["三角函數表","table of trigonometric function","三角函数表","sān jiǎo hán shù biǎo ","saam1gok3haam4sou3/sou2biu2"],
["正切；切線","tangent","正切；切线","zhèng qiē ；qiē xiàn ","zing3/zeng3cit3；cit3sin3"],
...
["終點","terminal point","终点","zhōng diǎn ","zung1dim2"],
["終邊","terminal side","终边","zhōng biān ","zung1bin1"],
["有限小數","terminating decimal","有限小数","yǒu xiàn xiǎo shù ","jau5haan6siu2sou3/sou2"],
["檢驗；試驗；測驗；檢定","test","检验；试验；测验；检定","jiǎn yàn ；shì yàn ；cè yàn ；jiǎn dìng ","gim2jim6；si3jim6；cak1jim6；gim2ding6"],
["四面形；四面體","tetrahedron","四面形；四面体","sì miàn xíng ；sì miàn tǐ ","sei3min6jing4；sei3min6tai2"],
...
["倍；乘","times","倍；乘","bèi ；chéng ","pui5；sing4"],
["轉移矩陣","transition matrix","转移矩阵","zhuǎn yí jǔ zhèn ","zyun3ji4geoi2zan6"],
["遞移律","transitive law","递移律","dì yí lǜ ","dai6ji4leot6"],
["平移","translation","平移","píng yí ","ping4/peng4ji4"],
["橫截軸；貫軸","transversal axis","横截轴；贯轴","héng jié zhóu ；guàn zhóu ","waang4zit6zuk6；gun3zuk6"],
["梯形法","trapezoidal method","梯形法","tī xíng fǎ ","tai1jing4faat3"],
["三角形","triangle","三角形","sān jiǎo xíng ","saam1gok3jing4"],
["三角[形]不等式","triangle inequality","三角[形]不等式","sān jiǎo [xíng ]bù děng shì ","saam1gok3[jing4]bat1dang2sik1"],
["三角錐；三稜錐","triangular pyramid","三角锥；三棱锥","sān jiǎo zhuī ；sān léng zhuī ","saam1gok3zeoi1；saam1ling4zeoi1"],
["三角剖分；三角測量","triangulation","三角剖分；三角测量","sān jiǎo pōu fèn ；sān jiǎo cè liàng ","saam1gok3fau2fan1/fan6；saam1gok3cak1loeng4"],
...
["聯[集]；併","union","联[集]；并","lián [jí ]；bìng ","lyun4[zaap6]；bing3"],
...
["單變數多項式；一元多項式","univariate polynomial","单变数多项式；一元多项式","dān biàn shù duō xiàng shì ；yī yuán duō xiàng shì ","daan1bin3sou3/sou2do1hong6sik1；jat1jun4do1hong6sik1"],
["宇集","universal set","宇集","yǔ jí ","ju5zaap6"],
["未知元；未知數；未知量","unknown","未知元；未知数；未知量","wèi zhī yuán ；wèi zhī shù ；wèi zhī liàng ","mei6zi1jun4；mei6zi1sou3/sou2；mei6zi1loeng4"],
...
["變量；變數；變元；變項","variable","变量；变数；变元；变项","biàn liàng ；biàn shù ；biàn yuán ；biàn xiàng ","bin3loeng4；bin3sou3/sou2；bin3jun4；bin3hong6"],
["變異數","variance","变异数","biàn yì shù ","bin3ji6sou3/sou2"],
["向量","vector","向量","xiàng liàng ","hoeng3loeng4"],
["速度","velocity","速度","sù dù ","cuk1dou6"],
["文氏圖","Venn diagram","文氏图","wén shì tú ","man4si6tou4"],
["頂點","vertex","顶点","dǐng diǎn ","ding2/deng2dim2"],
["鉛垂的；頂點的","vertical","铅垂的；顶点的","qiān chuí de ；dǐng diǎn de ","jun4seoi4dik1；ding2/deng2dim2dik1"],
["鉛直線","vertical line","铅直线","qiān zhí xiàn ","jun4zik6sin3"],
["波峰","wave crest","波峰","bō fēng ","bo1fung1"],
["波谷","wave trough","波谷","bō gǔ ","bo1guk1"],
["權[重]函數","weight","权[重]函数","quán [zhòng ]hán shù ","kyun4[cung5/zung6]haam4sou3/sou2"],
["加權平均[值]；加權平均數","weighted mean","加权平均[值]；加权平均数","jiā quán píng jun1 [zhí ]；jiā quán píng jun1 shù ","gaa1kyun4ping4/peng4gwan1[zik6]；gaa1kyun4ping4/peng4gwan1sou3/sou2"],
["非負整數","whole number","非负整数","fēi fù zhěng shù ","fei1fu6zing2sou3/sou2"],
["功","work","功","gōng ","gung1"],
["x坐標","x-coordinate","x坐标","xzuò biāo ","xzo6/co5biu1"],
["x截距","x-intercept","x截距","xjié jù ","xzit6keoi5"],
["xy平面","xy-plane","xy平面","xypíng miàn ","xyping4/peng4min6"],
["y坐標","y-coordinate","y坐标","yzuò biāo ","yzo6/co5biu1"],
["y截距","y-intercept","y截距","yjié jù ","yzit6keoi5"],
["年","year","年","nián ","nin4"],
["z截距","z-intercept","z截距","zjié jù ","zzit6keoi5"],
["零；零位；零點","zero","零；零位；零点","líng ；líng wèi ；líng diǎn ","ling4；ling4wai6/wai2；ling4dim2"],
...
function a2d(){
document.aba.D.value="";
for (i=0; i<abList.length; i++)
  if(document.aba.A.value==abList[i][0])
    {document.aba.D.value=document.aba.D.value + abList[i][3] + "/";};
    
    
if(document.aba.D.value=="")
  document.aba.D.value="Not found.";
else
  document.aba.D.value=document.aba.D.value.substr(0,document.aba.D.value.length-1); //delete the final slash.
}

function a2e(){
document.aba.E.value="";
for (i=0; i<abList.length; i++)
  if(document.aba.A.value==abList[i][0])
    {document.aba.E.value=document.aba.E.value + abList[i][4] + "/";};
    
if(document.aba.E.value=="")
  document.aba.E.value="Not found.";
else
  document.aba.E.value=document.aba.E.value.substr(0,document.aba.E.value.length-1); //delete the final slash.
}
...
{document.aba.A.value="Not found";}
  ...
  document.aba.A.value=document.aba.A.value.substr(0,document.aba.A.value.length-1); //delete the final slash.
}
...
h2   {color: orange;font-family:"verdana"; font-size: "2"}
;</style>
...
<br />
Jyuping: <input type="text" name="E" size="15">
<br />
...
<input type="button" value="jyuping" onClick="a2e()">
</p>
</form>
